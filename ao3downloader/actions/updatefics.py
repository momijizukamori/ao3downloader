...
class UpdateFicsAction:
    def action(self: BaseAction):
        with Repository() as repo:
            ...
            fics = get_files_of_type(folder, update_filetypes, self.log)
            ...
            ao3 = Ao3(repo, self.fileops, download_filetypes, None, False, images, output = self.log)

            self.progress(lambda work: ao3.update(work['link'], work['chapters']), works_cleaned)
